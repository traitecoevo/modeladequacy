...
%% Make sure to state clearly than once we have contructed the unit tree we don't need 
%% to simulate from the model. We simulate from BM with rate 1.
[Figure \ref{fig:flowchart} around here]
%% Perhaps put rescaling in a box and this section be on why we need to rescale and what the final step is (compare simulated to observed)
