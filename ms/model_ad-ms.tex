...
% No mention of plants in the abstract?
...
%If you set this up as a list that will follow this sentence need to make the list easier for the reader to parse
%Two considerations?
...
%
% Not sure I agree that that this set up is logical
% Isn't model adequacy a subset of the first question, when the question is what is the mode of evolution?
% The other category of studies that our results are relevant for is when the mode of evolution is 
% an assumption used to build a model to test a subsequent hypothesis, for example how PICs  
% test hypotheses built on an assumption of brownian motion
%
...
% parallel construction problem, maybe "or an adequate description"
...
%It would be nice to foreshadow the sample size result a bit, somehow, and to point out that adequacy
% may depend on phylogenetic scale
